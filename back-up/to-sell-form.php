...
<?php 
	...
	if(isset($_FILES["file"])){
		...
		$tmp = explode(".", $_FILES["file"]["name"]);
		$extensionArchivo = end($tmp);
		$nombreArchivo = "$imagen.".$extensionArchivo;
		*/
        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navcol-1">
                <ul class="nav navbar-nav ml-auto">
                    <li class="nav-item" role="presentation"><a class="nav-link active" href="index.php" id="alertaa">Inicio </a></li>
                ...
                <form class="form-inline">
                    <div class="form-group">
                        <input class="form-control form-control-sm" type="text" name="search" placeholder="Buscar...">
                    </div>
                </form>
                <button class="btn btn-outline-warning btn-sm" type="button">Buscar </button>
            </div>
        </div>
    </nav>
    <div class="register-photo" style="padding-bottom:40px;padding-top:90px;">
        <div class="form-container">
            <form method="post" id="to-sell-form" action="javascript:enviarFormulario()">
                <div class="form-group">
                    <div class="form-row">
                        <div class="col">
                            <input class="form-control" type="text" name="title" required="" placeholder="Título" maxlength="12" minlength="12" style="margin: 10px;">
                        </div>
                        <div class="col"></div>
                    </div>
                </div>
                <div class="form-group">
                    <div class="form-row">
                        <div class="col d-flex">
                            ...
                            <input type="text" name="price" required placeholder="Precio" pattern="[0-9]+.*[0-9]*" class="form-control" style="max-width:385px;"/>
                ...
                <div class="form-group d-table">
                    ...
                    <select class="form-control" name="status">
                        <optgroup label="Elige una">
                            <option value="12" selected="">Nuevo</option>
                            <option value="13">Usado</option>
                        </optgroup>
                    </select>
                </div>
                <div class="form-group d-table">
                    ...
                    <select class="form-control" name="platform">
                        <optgroup label="Elige una">
                            <option value="14" selected="">Play-Station</option>
                            <option value="15">X-BOX</option>
